...
$(function(){$(document).pjax("a[data-pjax]","#data-container"),$(document).foundation();var n=!1;$("#menu-button, .exit-off-canvas").click(function(t){t.preventDefault(),n?($("#menu-button").removeClass("close"),n=!1):($("#menu-button").addClass("close"),n=!0)})});